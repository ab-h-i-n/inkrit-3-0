      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <div className="p-6 md:p-8 space-y-8">
            <div>
              <h1 className="text-4xl font-bold text-[#161E46] mb-4">
                {event.title}
              </h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 bg-[#CFD0EA] p-6 rounded-lg">
              <div>
                <h3 className="text-[#161E46] font-semibold mb-2">
                  Event Details
                </h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-[#161E46] p-6 rounded-lg">
                <h3 className="text-[#CFD0EA] font-semibold mb-4">
                  Event Coordinators
                </h3>
                  ...
                  {event.eventCoordinators.map((coordinator, index) => (
                    ...
                    >
                      ...
                      <Button
                        ...
                        onClick={() =>
                          window.open(
                            `https://wa.me/${coordinator.phone.replace(
                              /\s+/g,
                              ""
                            )}`,
                            "_blank"
